"""Pydantic schemas for per-cloud-account CPU/memory alert threshold
overrides (Phase 20). Any field left null means "use the platform-wide
default for this tier" - see app/config/settings.py's ALERT_CPU_*/
ALERT_MEMORY_* settings and AlertEvaluationService's resolution order.
"""
