...
from app.integrations.scheduler import (
    register_cloud_region_sync_job,
    register_cloud_resource_discovery_job,
    register_cloud_sync_job,
)
...
async def lifespan(app: FastAPI):
    ...
    register_cloud_region_sync_job(scheduler)
    register_cloud_resource_discovery_job(scheduler)
    scheduler.start()
    yield
...
def create_app() -> FastAPI:
    ...
    configure_tracing(app, db_engine)
